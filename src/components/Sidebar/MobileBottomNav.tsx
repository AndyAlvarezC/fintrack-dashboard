...
export default function MobileBottomNav({ className }: Props) {
  return (
    <div
      className={`w-[90%] max-w-md fixed bottom-0 inset-x-0 mx-auto flex justify-center items-center m-4 py-4 px-6 bg-black/10 backdrop-blur-lg rounded-4xl border border-white/20 shadow-lg ${className}`}
    >
