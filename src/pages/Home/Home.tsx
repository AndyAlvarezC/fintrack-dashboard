    ...
    <div className="flex flex-col w-full min-h-screen p-4 sm:p-6">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 w-full min-w-0">
        ...
        <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-9 gap-8 w-full min-w-0">
          {/* ROW 1 */}
          {/* Financial Analytics */}
          <div className="sm:col-span-2 lg:col-span-6 bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[300px]">
            <FinancialAnalytics />
          </div>

          {/* Spending Statistics */}
          <div className="sm:col-span-2 lg:col-span-3 bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[300px]">
            <SpendingStatistics />
          </div>

          {/* ROW 2 */}
          {/* Total Balance */}
          <div className="lg:col-span-3 bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[200px]">
            <TotalBalance />
          </div>
          ...
          {/* Expenses */}
          <div className="sm:col-span-2 lg:col-span-3 bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[200px]">
            <Expenses />
          </div>
          ...
          <div className="sm:col-span-2 lg:col-span-6 md:grid md:grid-rows-2 gap-4 min-w-0">
            <div className="bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[200px]">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-8 w-full min-w-0">
          <div className="bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[250px]">
            <MyCards />
          </div>
          <div className="bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[300px]">
            <Calendar />
          </div>
          <div className="sm:col-span-2 lg:col-span-1 bg-(--bg-primary) shadow-[0_0_15px_rgba(167,127,255,0.4)] p-4 rounded-lg min-h-[400px]">
            <TransactionHistory />
          </div>
        </div>
      </div>
